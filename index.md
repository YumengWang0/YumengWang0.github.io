...
<aside class="sticky-sidebar">
  ...
  <div class="sidebar-role">ML Engineer · Data Scientist<br>PhD Researcher</div>
  <div class="sidebar-affil">Missouri S&amp;T</div>
  <div class="sidebar-icons">
    <a href="mailto:yw2bc@mst.edu" title="Email"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg></a>
    <a href="https://www.linkedin.com/in/yumeng-wang-3990a1234/" target="_blank" title="LinkedIn"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg></a>
...
<main class="scroll-content">
  ...
  <section id="bio" class="content-section">
    ...
    <p class="bio-text">
      ...
      I specialize in building end-to-end ML systems — from production credit risk models at fintech
      companies to neural operator research for scientific simulation. Advised by Dr. Yanzhi Zhang,
      my doctoral research focuses on deep learning methods for solving complex physical systems,
  ...
  <section id="projects" class="content-section">
    ...
    <div class="proj-grid">
      <div class="card">
        ...
        <div class="card-body">
          <div class="tag-row"><span class="tag">LLM</span><span class="tag">RAG</span><span class="tag">Finance</span><span class="tag">ReAct</span></div>
          <div class="proj-title">LLM-powered financial analysis agent</div>
          <div class="proj-desc">ReAct-based agent using Google Gemini with dynamic tool orchestration. Three-layer memory architecture with ChromaDB and RAG retrieval pipeline.</div>
          <div class="card-links">
            <a href="https://github.com/YumengWang0" target="_blank" class="card-link">GitHub</a>
          </div>
        </div>
      </div>
      <div class="card">
        ...
        <div class="card-body">
          <div class="tag-row"><span class="tag">PyTorch</span><span class="tag">Quant</span><span class="tag">LLM API</span></div>
  ...
  <section id="papers" class="content-section">
    ...
    <div class="card pub-card">
      ...
      <div class="card-body">
        <div class="tag-row"><span class="tag">CNN</span><span class="tag">Reduced Order Modeling</span><span class="tag">2025</span></div>
        ...
        <div class="card-links"><a href="/files/Paper1.pdf" target="_blank" class="card-link">PDF</a></div>
      </div>
    </div>
    <div class="card pub-card">
      <div class="pub-img"><img src="/images/paper2-fig.png" alt="Paper 2" class="proj-img-fill"></div>
      <div class="card-body">
        <div class="tag-row"><span class="tag">CNN</span><span class="tag">Model Reduction</span><span class="tag">2024</span></div>
        ...
        <div class="pub-authors"><span class="pub-me">Yumeng Wang</span>, Yanzhi Zhang</div>
        <div class="card-links"><a href="/files/Paper2.pdf" target="_blank" class="card-link">PDF</a></div>
      </div>
    </div>
  </section>
